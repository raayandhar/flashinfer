...
class Fp8QuantizationType(IntEnum):
    ...
    # Per-tensor FP8
    PerTensorFp8 = 3
    # Per-channel FP8 (e.g. Llama 4 FP8, GLM-4.x)
    PerChannelFp8 = 4
            ...
            **kwargs,
            ...
            if self.dtype_weights == DtypeTrtllmGen.Bfloat16:
                ...
                if (
                    ...
                    self.fp8_quantization_type == Fp8QuantizationType.PerChannelFp8
                ):
...
def trtllm_fp8_per_channel_scale_moe(
    ...
    Uses per-channel (per-output-column) weight quantization scales instead of
    per-tensor scalar scales. This is the format used by models like Llama 4 FP8
    and GLM-4.x, and matches the checkpoint format used in vLLM and SGLang.
